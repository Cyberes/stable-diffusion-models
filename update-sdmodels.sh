...
perl -pi -e 's/<body class="m-0 p-0">/<body class="m-0 p-0">  <nav class="navbar navbar-expand-lg navbar-light bg-light" style="background-color:#6c757d42!important;">     <div class="container-fluid">       <div class="collapse navbar-collapse" id="navbarNavAltMarkup">         <div class="navbar-nav">           <a class="nav-link active" aria-current="page" href="\/stable-diffusion-models\/">Models<\/a>           <a class="nav-link" href="\/stable-diffusion-textual-inversion-models\/">Textual Inversion Models<\/a>           <a class="nav-link" href="\/stable-diffusion-dreambooth-library\/">DreamBooth Models<\/a>           <a class="nav-link active" href="\/stable-diffusion-models\/sdmodels\/">sdmodels<\/a>         <\/div>       <\/div>     <\/div>   <\/nav>/g' index.html
